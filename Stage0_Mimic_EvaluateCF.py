...
def evaluate(model, test_loader, shots, device, foldername=""):
    ...
    with tqdm(test_loader) as it:
        for batch_no, (clean_batch, noisy_batch, desc_batch) in enumerate(it, start=1):
            ...
            # route4 = 'H:/Paper03_Data/PTBXL_100Hz/' + 'Ori_Lead8_Cond.npy'
            # pickle.dump(clean_numpy, open(route4, 'wb'), protocol=4)
            # route5 = 'H:/Paper03_Data/PTBXL_100Hz/' + 'Re_Lead8_Cond.npy'
            # pickle.dump(out_numpy, open(route5, 'wb'), protocol=4)
            # route6 = 'H:/Paper03_Data/PTBXL_100Hz/' + 'Ori_Lead2_Cond.npy'
            # pickle.dump(noisy_numpy, open(route6, 'wb'), protocol=4)
            # route4 = 'H:/Paper03_Data/PTBXL_100Hz/' + 'Ori_Unet_01.npy'
            # pickle.dump(clean_numpy, open(route4, 'wb'), protocol=4)
            # route5 = 'H:/Paper03_Data/PTBXL_100Hz/' + 'Re_Unet_02.npy'
            # pickle.dump(out_numpy, open(route5, 'wb'), protocol=4)
            # route6 = 'H:/Paper03_Data/PTBXL_100Hz/' + 'Ori_Lead2_Unet.npy'
            # pickle.dump(noisy_numpy, open(route6, 'wb'), protocol=4)
            # route4 = 'H:/Paper03_Data/PTBXL_100Hz/' + 'Ori_DiT_01.npy'
            # pickle.dump(clean_numpy, open(route4, 'wb'), protocol=4)
            # route5 = 'H:/Paper03_Data/PTBXL_100Hz/' + 'Re_DiT_02.npy'
            # pickle.dump(out_numpy, open(route5, 'wb'), protocol=4)
            # route6 = 'H:/Paper03_Data/PTBXL_100Hz/' + 'Ori_Lead2_DiT.npy'
            # pickle.dump(noisy_numpy, open(route6, 'wb'), protocol=4)
    ...
    # np.save(foldername + '/CF4_withoutClass.npy', restored_sig)
